...
public class Home extends JFrame{
	...
	//Tool Bar
		...
		JButton newButton=new JButton(new ImageIcon("/Home_Intern_Project/photos/new.png"));
		JButton deleteButton=new JButton(new ImageIcon("/Home_Intern_Project/photos/delete.png"));
		JButton saveButton=new JButton(new ImageIcon("/Home_Intern_Project/photos/save.png"));
		JButton previousButton=new JButton(new ImageIcon("/Home_Intern_Project/photos/privious.jpg"));
		JButton nextButton=new JButton(new ImageIcon("/Home_Intern_Project/photos/next.jpg"));
		JButton printButton=new JButton(new ImageIcon("/Home_Intern_Project/photos/print.png"));
		JButton exitButton = new JButton(new ImageIcon("/Home_Intern_Project/photos/exit.png"));
	//Frame
		...
		ImageIcon(Home.photoTextArea.getText()).getImage();
		int w = getWidth();
		int h = getHeight();
	 ...
	 class InventoryDocument implements Printable
		...
		g2D.drawString("Location: " + Home.myInventory[i].location, (int)
		...
		Home.myInventory[i].serialNumber, (int) (pf.getImageableX() + 25), y);
		y += dy;
		g2D.drawString("Price: $" + Home.myInventory[i].purchasePrice + ",Purchased on: " + Home.myInventory[i].purchaseDate, (int) (pf.getImageableX() +
		25), y);
		y += dy;
		g2D.drawString("Purchased at: " +
		Home.myInventory[i].purchaseLocation, (int) (pf.getImageableX() + 25), y);
		y += dy;
		g2D.drawString("Note: " + Home.myInventory[i].note, (int)
		(pf.getImageableX() + 25), y);
		y += dy;
		try
		{
		...
		ImageIcon(Home.myInventory[i].photoFile).getImage();
